...
<body bgcolor="#4e4e4e" onload="initialize_oar_map(48.41826449418743,-71.23947143554687,400000);"> <!--5,45.4988649065219,-73.55938374996185-->
<div id="gridbox" style="height:300px;width:970px; background-color: #4e4e4e"></div>
...
mygrid.setInitWidths("30,50,150,100,100,100,75,100,100,70,*");    //7th should be 100 or so for the Image
...
<table bgcolor='#EEEEEE' cellpadding="0" width="970">
      <tr >
            <td bgcolor='#EEEEEE' valign="top" width="50%">
                <table bgcolor='#EEEEEE' cellpadding="8" width="100%">
                    <tr>
                        <td bgcolor='#e4e0d8'>
                            <small><b>ImajieMatch-GEO JOOMLA Component</b><br/></small>
