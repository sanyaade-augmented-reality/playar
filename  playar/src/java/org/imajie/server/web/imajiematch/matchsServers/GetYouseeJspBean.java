 ...
 */
public class GetYouseeJspBean implements Serializable {
    
    private static Logger logger = Logger.getLogger(GetYouseeJspBean.class.getName());
    private static final String[] wordsNS = {"", "north", "south"};
    private static final String[] wordsEW = {"", "east", "west"};
    
    public String getYousee(HttpServletRequest request) {
