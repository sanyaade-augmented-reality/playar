...
import org.imajie.server.web.imajiematch.matchsServers.openwig.*;
import org.imajie.server.web.imajiematch.matchsServers.main.Main;
import org.imajie.server.web.imajiematch.matchsServers.gps.GPSManager;
import org.imajie.server.web.imajiematch.matchsServers.gps.Simulator;
...
//		}
	...
	protected void setMedia (Media media) {
            ...
            detailMedia = media.name;
            
//            Engine.instance.gwcfile.(media.name);
//            
//            try {
//			if (media == null);
