...
var markerImage = new google.maps.MarkerImage('<?php echo $this->oar_browser_dir ?>images/ImajieMatchs_logo_fav.png',
      		new google.maps.Size(32, 57),	//99/115
      		new google.maps.Point(0,0),
     		new google.maps.Point(16, 8));

var markerShadow = new google.maps.MarkerImage('<?php echo $this->oar_browser_dir ?>images/shadow-block.png',
      		new google.maps.Size(57, 57),	//99/115
      		new google.maps.Point(0,0),
     		new google.maps.Point(16, 8));
     	<?php } ?>
...
<?php if(isset($this->results)) { ?>
		<div id="mapview_listview" class="results">
                    <table class="results" width="100%" style="color: #FFFFFF; background-color: #000000">
				<tr>
					<td style="vertical-align:middle; white-space: nowrap; overflow: hidden; padding: 0px;"  width="50%">
						<span id="location-area" class="small" style="color: #FFFFFF; font-size:12px; background-color: #000000;">
						<form id="location-input" onsubmit="geocodeAddress('<?php echo $this->geo_bias ?>'); return false;">
							...
							<input class="stndsmall" type="submit" value="Ma position" style="font-size: 11px; padding: 0px;">
						</form>
					...
					<td valign="top" style="white-space: nowrap; overflow: hidden;">
						...
						<?php } else { ?>
							<b style="font-size: 90%">Carte<?php /* <i>Beta</i> */?></b>
						<?php } ?>	 
						</span></p>
					</td>
				</tr>
