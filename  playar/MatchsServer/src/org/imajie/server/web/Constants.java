...
public final class Constants
{
    ...
    public static final String STDLIB = "/org/imajie/server/web/imajiematch/matchsServers/openwig/stdlib.lbc";
    ...
    // Fix the duration witch player server remain on without player trigger in milliseconds
    public static final int PLAYER_SERVER_TIMEOUT = 1800000; // 30 min.
    
    public static final String PLAYER_SERVER_LAUNCH_SCRIPT = "/opt/tomcat7/playar/bin/PlayerServer/PlayerMatchServer.jar";
   ...
   public static final String IMAJIE_SERVER = "http://localhost/joomla/index.php/component/imajiematchconnect?task=imajiematch.connect&format=xmlrpc";
