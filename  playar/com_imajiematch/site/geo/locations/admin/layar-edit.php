...
function add_row($rowId){
	...
	$sql = 	"INSERT INTO saj_imajiematch_layar_poi(int_point_id,var_type,var_title,var_line_2,var_line_3,
...
function update_row($rowId){
	...
	$sql = 	"UPDATE saj_imajiematch_layar_poi SET  var_type='".clean_data($_REQUEST["c1"])."',
...
function delete_row($rowId){
	...
	$d_sql = "DELETE FROM saj_imajiematch_layar_poi WHERE int_point_id=".$rowId;
