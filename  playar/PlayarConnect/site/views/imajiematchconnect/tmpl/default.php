...
$request_method = 'imajiematch.connect';
...
$response = file_get_contents(JURI::base()."index.php?option=com_imajiematchconnect&task=$request_method&format=xmlrpc", false, $context);
