...
<body bgcolor="#000000" onunload="GUnload();" onload="<?php echo $oar->body_onload ?>">
<?php } ?>
	...
	<div class="whole-page">
		...
		<?php if(!$oar->template_url) { ?>
		<?php } ?> 
            <form style=" visibility: hidden;" action="<?php echo $oar_browser_path ?>" name="lpf">
			...
			<?php } ?>
				...
				<?php } ?>
		<?php if(!$oar->template_url) { ?><?php } ?>
			
			<?php if(!isset($oar->results)) { ?>
				<span class="small" style="color: #ffffff; background-color: #000000">Entre l'adresse un match</span>
			<?php } ?>
		</form>
		...
		<noscript>
		<span class="small">Attention: Javascript doit �tre activ� pour que la localisation fonctionne !</span>
		</noscript>
		...
		<?php if((($oar->oar_description != "")||($oar->oar_logo != ""))&&
			...
			<hr align="left" class="results">
                        <table class="results" style=" background-color: #000000;">
				<tr>
					<?php if($oar->oar_logo != "") { ?>
					...
					<td valign="top" style="padding-left:10px;">
						<span class="small" style="color: #ffffff; background-color: #000000"><?php echo $oar->oar_description ?></span>
					</td>
