...
public class Navigator {
	...
	public static String getDistanceAndDirection (ZonePoint zp) {
		//LocationService gps = getActiveGPS();
			...
			String dist = zp.friendlyDistance(Engine.instance.lat, Engine.instance.lon);

			double dx = zp.latitude - Engine.instance.lat;
			double dy = zp.longitude - Engine.instance.lon;
	...
	public static String getDistanceOnly (ZonePoint point) {
			...
			return point.friendlyDistance(Engine.instance.lat, Engine.instance.lon);
