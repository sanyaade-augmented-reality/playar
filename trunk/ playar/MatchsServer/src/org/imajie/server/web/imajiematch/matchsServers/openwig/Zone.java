	...
	private void setcontain () {
		...
		switch (contain) {
			case INSIDE:
				...
				//System.out.println("ZONE: inside "+name);
				Engine.callEvent(this, "OnEnter", null);
				break;
			case PROXIMITY:
                            // TODO implements a debug state to see the line below in the logs
				//System.out.println("ZONE: proximity "+name);
				Engine.callEvent(this, "OnProximity", null);
				break;
			case DISTANT:
                            // TODO implements a debug state to see the line below in the logs
				//System.out.println("ZONE: distant "+name);
				Engine.callEvent(this, "OnDistant", null);
				break;
			case NOWHERE:
                            // TODO implements a debug state to see the line below in the logs
				//System.out.println("ZONE: out-of-range "+name);
