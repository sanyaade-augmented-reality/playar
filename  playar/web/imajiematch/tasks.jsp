<%-- 
    Document   : tasks
    Created on : Aug 22, 2011, 10:31:19 PM
    Author     : Carl Tremblay
--%>


<jsp:useBean id="parameters" scope="request" class="org.imajie.server.web.imajiematch.matchsServers.GetTasksJspBean" />
