 ...
 */
public class GetLocationsJspBean implements Serializable {

    private static Logger logger = Logger.getLogger(GetLocationsJspBean.class.getName());
    ...
    public String getLocations(HttpServletRequest request) {
        ...
        if (session.getAttribute("zoneCount") != null) {
            ...
            msg = "There is no place to go</br><div data-role='fieldcontain'  data-theme='a'>"
                    ...
                    + "<a href='http://m.layar.com/open/imajiematch' data-transition='slide' data-role='button'>Return to mission</a>"
                    + "</div>";
