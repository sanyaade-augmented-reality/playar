<%-- 
    Document   : yousee
    Created on : Aug 22, 2011, 10:34:25 PM
    Author     : Carl Tremblay
--%>

<jsp:useBean id="parameters" scope="request" class="org.imajie.server.web.imajiematch.matchsServers.GetYouseeJspBean" />
